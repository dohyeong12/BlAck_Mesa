...
행동은 OX퀴즈,점프게임,청기백기,눈피하기 총 4가지 미니게임을 통해 표현하였다.
...
배준우(edwin2514381@naver.com) : 눈피하기 게임 개발, 최종발표, 기획
...
체력을 사용하는 행동에는 온동,공부,일 3가지가 존재하고 행동을 선택하면 OX퀴즈,점프게임,청기백기,눈피하기 중 하나를 랜덤으로 플레이하게된다.
